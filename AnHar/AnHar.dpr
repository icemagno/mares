...
begin
  ...
  else if (ParamStr(1) = '5') then
    Dir.geraTabua( StrToInt( ParamStr(2) ), StrToInt( ParamStr(3) ), ParamStr(4), StrToInt( ParamStr(5) ), ParamStr(6))

  else if (ParamStr(1) = '6') then
    Dir.geraPrevisaoCombinada( StrToInt( ParamStr(2) ), StrToInt( ParamStr(3) ), ParamStr(4) );
